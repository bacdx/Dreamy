...
import com.example.dreamy.UI.Activity.Adapter.HoaDonAdapter;
import com.example.dreamy.UI.Activity.Model.CategoryPhake;
import com.example.dreamy.UI.Activity.Model.Order;
import com.example.dreamy.UI.Activity.Utils.OrderStatus;
import com.example.dreamy.databinding.FragmentDangGiaoBinding;
...
public class DangGiaoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDangGiaoBinding.inflate(getLayoutInflater());
    ...
    private List<Order> getOrders(){
        ...
        lists.add(new Order("","VN-2145", OrderStatus.DANG_GIAO,getRandom()));
        lists.add(new Order("","VN-6585",OrderStatus.DANG_GIAO,getRandom()));
        lists.add(new Order("","VN-5984",OrderStatus.DANG_GIAO,getRandom()));
        return lists;
    }
