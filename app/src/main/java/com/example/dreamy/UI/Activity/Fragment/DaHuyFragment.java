...
public class DaHuyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDaHuyBinding.inflate(getLayoutInflater());
    ...
    private List<Order> getOrders(){
        ...
        lists.add(new Order("","VN-2145", OrderStatus.DA_HUY,getRandom()));
        lists.add(new Order("","VN-6585",OrderStatus.DA_HUY,getRandom()));
        lists.add(new Order("","VN-5984",OrderStatus.DA_HUY,getRandom()));
        return lists;
    }
